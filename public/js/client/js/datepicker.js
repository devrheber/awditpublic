...
(function($, undefined) {
        ...
        place: function() {
            ...
            if (yorient === "auto") {
                ...
                bottom_overflow =
                    scrollTop +
                    windowHeight -
                    (offset.top + height + calendarHeight);
            ...
            if (yorient === "top") top += height;
                ...
                top -=
                    calendarHeight + parseInt(this.picker.css("padding-top"));
        ...
        keydown: function(e) {
            ...
            switch (e.keyCode) {
                ...
                case 39: // right
                    ...
                    if (e.ctrlKey) {
                        newDate = this.moveYear(
                            this.dates.get(-1) || UTCToday(),
                            dir
                        );
                        newViewDate = this.moveYear(focusDate, dir);
                        this._trigger("changeYear", this.viewDate);
                    } else if (e.shiftKey) {
                        newDate = this.moveMonth(
                            this.dates.get(-1) || UTCToday(),
                            dir
                        );
    ...
    var DPGlobal = {
        ...
        headTemplate:
            "<thead>" +
            "<tr>" +
            '<th style="font-weight:700; font-size:1rem" colspan="5" class="datepicker-switch text-left">&nbsp;</th>' +
...
// 	{
// 		if(typeof(e.date) == "undefined") return alert($(this).val());
