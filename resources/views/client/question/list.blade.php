        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">{{ __('message.Questionnarie Data') }}
                    <a href="{{ route('client.question.create')}}" class ="btn btn-primary float-right" data-toggle="tooltip" data-placement="bottom" title="{{ __('message.Create Questionnarie Group')}}"> 
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('client.question.edit',$questionnary->id)}}" class ="btn btn-primary"
                                        data-toggle="tooltip" data-placement="bottom" title=" {{ __('message.Edit Questionnarie Group')}}">
                                            <i class ="fa fa-edit"></i>
                                    </a>
                                    <a href="{{ route('client.quesionnarie.index')}}" class ="btn btn-primary"
                                        data-toggle="tooltip" data-placement="bottom" title="{{ __('message.Add QUestionnaries')}}">
                                            <i class ="fa fa-plus"></i>    
                                    </a>
                                    <form action ="{{ route('client.question.delete', $questionnary->id )}}" method="POST">
                                        @csrf
                                        @method('DELETE')
