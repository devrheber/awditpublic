        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="inner_right_agenda">
                    <div class="new_event_st">
                        <h4>Next events</h4>
                        <div class="row">
                            @foreach ($events as $event)
                                <div class="col-md-4"><span>{{ $event->start_date }}</span></div>
                                <div class="col-md-4"><span>{{ $event->event_name }}</span></div>
                                <div class="col-md-4"><span>{{ $event->start_time }}</span></div>
                            @endforeach
                        </div>
                    </div>
                    <div class="right_day_list_agenda" id="todayeventlist">
                        <h2>
                            <span class="btn btn-info" id="previous_day"> <i class="fa fa-angle-left"></i></span>
                            <span id="today"> {{ $today }}</span>
                            <span class="btn btn-info" id="next_day"> <i class="fa fa-angle-right"></i></span>
                        </h2>
                        <ul id="todayevnets">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <input type="text" name="end_time" class="form-control datetimepicker-input"
                                    id="datetimepicker5" required placeholder="Select End Time" data-toggle="datetimepicker"
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            var eventDates = {};
            eventDates[new Date('05/13/2021')] = new Date('05/13/2021');
            ...
            $('#calendar').datepicker({
                ...
                beforeShowDay: function(date) {
                    ...
                    if (highlight) {
                        ...
                        return [true, "highlight-event", 'Tooltip text'];
                    } else {
                        return [true, '', ''];
                    }
                },
