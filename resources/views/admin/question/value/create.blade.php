...
@section('title','create Question Value')
            ...
            <div class="container">
                <div class="row">
                    <div class="col s10 m6 l6">
                        <h5 class="breadcrumbs-title mt-0 mb-0"><span>{{__('message.Create Question Value')}}</span></h5>
                        <ol class="breadcrumbs mb-0">
                            <li class="breadcrumb-item"><a href="{{url('/dashboard')}}">Home</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('admin.questionvalue.list')}}">{{__('message.Question Value')}}</a></li>
                            <li class="breadcrumb-item"><a href="#">{{__('message.Create Question Value')}}</a></li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <div id="input-fields" class="card card-tabs">
                            <div class="card-content">
                                ...
                                <div id="view-input-fields">
                                    <div class="row">
                                        <div class="col s12">
                                            <form action="{{ route('admin.questionvalue.store')}}" method="post">
                                                @csrf
                                                <div class="col s12">
                                                ...
                                                <div class="col s12">
                                                    <div class="input-field col s12">
                                                        <input type="text" step="0.01" class="form-control" id= "description" name="description">
