...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __(' supplier Register') }}</div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('supplier.register') }}">
                        @csrf
                        <input type="hidden" name="invited_by" value ="{{ $inviteduser->sender_id}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{  $inviteduser->email ?? old('email') }}" required autocomplete="email">
