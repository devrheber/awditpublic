...
<html>
  <body>
    ...
    <br/>
    <a href="{{ route('supplier.login.form')}}">{{__('message.login to plateform')}}</a>
    <p> 
      {{ __('message.If you click and any not perform any action then please click on this link') }}
      <a href="http://chessmafia.com/php/SEAT/supplier/login"> http://chessmafia.com/php/SEAT/supplier/login </a>
    </p>
  </body>
</html>